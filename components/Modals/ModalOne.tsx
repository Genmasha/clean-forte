...
export default function Modal(props: Props) {
  const { open, setOpen, error, isLoading, modalError, modalSuccess, button, modalTitleError, modalTitleSuccess } =
    props
                  ...
                  <>
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">{error ? modalError : modalSuccess}</p>
                        </div>
                      </div>
                    </div>
